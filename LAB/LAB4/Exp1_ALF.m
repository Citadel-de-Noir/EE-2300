...
E1 = readtable("D:\ISU_Files\ISU_Files\SPRING_2026\EE 2300\LAB\LAB4\Exp1_ALF_Loop.csv");
...
magE1_1 = 20*log10((R2./R1)*(w_c./sqrt(w_c.^2+w.^2)));
phaseE1_1 = rad2deg(pi - atan(w./w_c));
